...
<div class="row justify-content-center">
    <form class="col-lg-4 border rounded shadow p-4" style="background-color: #f7f9fc; border: none; border-radius: 12px; box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.1); padding: 40px;">
        ...
        <div class="form-group mb-4">
            ...
            <input type="password" name="us_password" id="us_password" class="form-control" style="border-radius: 10px; border: 1px solid #ced4da; padding: 12px; font-size: 14px; color: #495057;">
        </div>
        <div class="d-grid">
